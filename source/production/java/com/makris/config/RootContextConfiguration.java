...
@EnableJpaRepositories(
        basePackages = "com.makris.site.repositories",
        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    public Jaxb2Marshaller jaxb2Marshaller()
    {
        ...
        marshaller.setPackagesToScan(new String[] { "com.makris.site" });
        return marshaller;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
    {
        ...
        factory.setPackagesToScan("com.makris.site.entities",
                "com.makris.site.converters");
