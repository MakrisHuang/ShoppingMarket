...
public class CartItemForOrder {
    ...
    public CartItemForOrder(){}

    public CartItemForOrder(CartItem cartItem){
        this.id = cartItem.getId();
        this.amount = cartItem.getAmount();
        this.shoppingItem = cartItem.getShoppingItem();
    }

    @Id
    @Column(name = "CartItemForOrderId")
